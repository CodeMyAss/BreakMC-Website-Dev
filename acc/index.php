    ...
    <body>
        ...
        <?php
            ...
            if($log) {
                ...
                echo '<div style="margin-top: -250px; display:block; width: 100%; opacity: 1.0; text-align:center;" class="logged_in_error"><span class="glyphicon glyphicon-remove" style="font-size: 128px;"></span>
                    <br>
                    <h2 style="margin-top: -5.6px;">You\'re already logged in.<br><small style="margin-top: -5.6px;">' . SessionUtil::getUsername() . '</small></h2></div>';
                    
                echo '<script>slideError();</script>';
                die();
            ...
            if($_SERVER['REQUEST_METHOD'] == "POST") {
                ...
                $valid = SessionUtil::auth($con, $user, $pass);
                
                if($valid) {
                    SessionUtil::storeAccount($user, $pass);
                    ?>
                                ...
                                <?php
                                    ...
                                    if($log) {
                                        ...
                                        ?>
                                            ...
                                            <a href="signout.php" class="btn btn-primary" style="width: 95%; margin-left: 2%;">Sign Out</a><br><hr>
                                        ...
                                        ?>
                                            ...
                                            <form action="<?php echo stripslashes(htmlspecialchars($_SERVER['PHP_SELF'])); ?>" method="post">
        ...
        <div class="container" style="margin-top: 70px;">
            ...
            <div class="alert alert-danger"><strong>Sorry! </strong>Your details are incorrect. Please try again below.</div><br>
                ...
                <form action="<?php echo stripslashes(htmlspecialchars($_SERVER['PHP_SELF'])); ?>" method="post">
                        ...
                        <div class="form-body">
                            ...
                            <input type="submit" class="btn btn-primary" placeholder="Login" style="margin-top: -5px; width: 100%; height: 60px;">
